// we typed in shortcut rfc (react function component)
// we typed impt shortcut fo proptypes
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className={`form-check form-switch text-${props.mode === 'light' ? 'dark' : 'light'}`}>
                        ...
                        <label className="form-check-label" hmtlFor="flexSwitchCheckDefault">Toggle Mode</label>
                    </div>
                </div>
            </div>
        </nav>
